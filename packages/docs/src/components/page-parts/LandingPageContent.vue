<template>
  <section class="landing-page markdown-brand">
    ...
    <div class="byline">
      <p>
        Build clean scroller inputs for string choices, dates, times, date-time values, and ranges
        with a small set of focused Quasar components.
      </p>
    </div>
    ...
    <div class="byline">
      <p>
        ...
        <a href="https://github.com/quasarframework/quasar-ui-qscroller" target="_blank">
          QScroller GitHub repo
        </a>
        and the
    ...
    <div class="byline">
      <p>
        ...
        assistance, please reach out through the QScroller repository or GitHub Discussions.
      </p>
    </div>
  </section>
</template>
