  ...
  children: [
    {
      name: 'GitHub',
      icon: fabGithub,
      path: `https://github.com/quasarframework/quasar-ui-qscroller/tree/${repoBranch}`,
      external: true,
    },
    {
      name: 'X (Twitter)',
...
const docsMenus: SiteMenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'QTimeScroller', path: '/developing/qtime-scroller' },
      { name: 'QTimeRangeScroller', path: '/developing/qtime-range-scroller' },
...
const config: SiteConfig = {
  ...
  codepen: {
    ...
    jsSetup: [
      'const QScrollerPlugin = (globalThis as any).QScroller',
      'app.use(QScrollerPlugin)',
    ].join('\n'),
  },
  license: {
    label: 'MIT License',
