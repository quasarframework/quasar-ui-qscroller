...
This package contains the Q-Press documentation site for QScroller. It owns the public documentation source, live demos, example-viewer content, generated API pages, and static-search output for wheel scrollers, range pickers, and Timestamp adapter examples.
