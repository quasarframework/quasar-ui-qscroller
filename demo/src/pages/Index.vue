<template>
  <div>
    <section class="page-header">
      <h1 class="project-name">QScroller</h1>
      <h2 class="project-tagline"></h2>
      <a href="https://github.com/quasarframework/app-extension-qscroller" target="_blank" class="btn">View on GitHub</a>
      <a href="/app-extension-qscroller/#/demo" target="_blank" class="btn">Demo</a>
    </section>
...
<style>
.q-markdown--table tr:nth-child(odd) {
...
.q-markdown pre {
  background-image: linear-gradient(transparent 3%, #bfe0fb 0)!important;
  color: #555;
  background-color: #bfe0fb!important;
}
.q-markdown--code__inner {
  border-left: 2px solid #afa0ff!important;
 }
